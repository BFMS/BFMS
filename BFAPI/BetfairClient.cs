...
namespace BFAPI
{
    ...
    public class BetfairClient
    {
        ...
        private string appKey="NxitMKPa6yTkBjpj";
        ...
        public BetfairClient(Exchange exchange,  Action preNetworkRequest = null, WebProxy proxy = null)
        {
        ...
        public bool Login(string p12CertificatePassword, string username, string password)
        {

            ResourceManager rm = new ResourceManager("BFAPI.Properties.Resources", Assembly.GetExecutingAssembly());
            byte[] p12Certificate = rm.GetObject("client_2048") as byte[];

            if (string.IsNullOrWhiteSpace(p12Certificate.ToString())) throw new ArgumentException("p12CertificateLocation");
            ...
            X509Certificate2 x509certificate = new X509Certificate2(p12Certificate, p12CertificatePassword);
    ...
    public class BetfairServerException : System.Exception
    {
        ...
        public static BetfairServerException ToClientException(Shared.BFDO.Exceptions.Exception ex)
        {
            if (ex == null)
                return null;
